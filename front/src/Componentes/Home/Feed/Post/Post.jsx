...
import Likes from "./Frag/Likes";
import Comentarios from "./Frag/Comentarios";
import Compartilhar from "./Frag/Compartilhar";
  ...
  return (
    <section className={style.post}>
      ...
      <div className={style.interacao}>
        ...
        <Comentarios links={links} content={content} />
        <Compartilhar content={content}/>
      </div>
    </section>
  );
};
